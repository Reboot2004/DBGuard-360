...
def monitor_database(database_name):
    ...
    try:
        ...
        print("   3. IMPORTANT: Disable autocommit first!")
        print("      SET autocommit = 0;")
        print("   4. Execute your queries with explicit transactions:")
        print("      START TRANSACTION;")
        print("      INSERT INTO table VALUES (...);")
        print("      COMMIT;  -- This triggers logging")
        print("   5. Use the GUI to view logs: python view_logs_gui.py")
        print()
        print("⚠️  IMPORTANT: Autocommit must be OFF!")
        print("   Check with: SELECT @@autocommit;")
        print("   Turn off: SET autocommit = 0;")
        print()
